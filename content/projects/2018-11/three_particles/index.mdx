...
You should use Chrome Dev (Canary no does no longer have this available) and start with some flags:  
`"[PATH_TO_CHROME_DEV]\chrome.exe" --enable-webgl2-compute-context --use-cmd-decoder=passthrough`
